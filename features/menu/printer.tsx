...
import { ScrollView, View, RefreshControl, Pressable, ActivityIndicator, Platform } from "react-native"
...
import { Bluetooth, Check, Settings, Printer, RefreshCw, Trash2 } from "lucide-react-native"
...
export default function PrinterScreen() {
  ...
  useEffect(() => {
    ...
    initRef.current = true
      ; (async () => {
        ...
        if (hasPerms) await loadPairedDevices()
      })()
  }, [])
  ...
  const handleRequestPermissions = useCallback(async () => {
    ...
    if (granted) await loadPairedDevices()
    setIsRequestingPermissions(false)
  }, [requestPermissions, loadPairedDevices])
  ...
  // ----- Permission Required (Android only) -----
  if (needsPermissions && Platform.OS === "android") {
    return (
