...
import { Check, AlertCircle, ShieldCheck, FileText, ClipboardList } from "lucide-react-native"
import { Icon } from "@/components/ui/icon"
import type { ProgressStep } from "../api/pengeluaran.service"
...
const STEPS = [
  ...
  { key: "pengeluaran", label: "Header", icon: FileText },
        ...
        <View className="bg-background w-full max-w-sm rounded-[--radius] px-2 py-8 gap-2">
          ...
          <View className="items-center gap-2">
            ...
            <Text className="font-mono-bold text-lg text-center">
              {isCompleted ? "Selesai" : isFailed ? "Gagal" : "Menyimpan pengeluaran..."}
            </Text>
          </View>

          {/* Step Indicators */}
          {!isCompleted && !isFailed && (
            <View className="flex-row justify-center gap-4 px-2">
