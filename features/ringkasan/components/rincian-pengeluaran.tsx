        ...
        <View className="border border-border bg-background">
          ...
          <View className="p-2 gap-2">
            ...
            <View className="flex-row justify-between items-center">
              ...
              <Text className="text-destructive font-mono-bold text-lg">
                ...
                <View className="p-2 gap-2">
                  <View className="flex-row justify-between items-start">
                    <View className="flex-1 pr-2">
                      <Text className="text-primary font-mono-bold text-sm uppercase">
                        {item.kategori}
                      </Text>
                      {item.keterangan && (
                    ...
                    <Text className="text-destructive font-mono-bold text-sm">
